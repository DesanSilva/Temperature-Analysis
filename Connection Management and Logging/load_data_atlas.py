...
PATH_TO_CERTIFICATE = "" #.pem.crt file path
PATH_TO_PRIVATE_KEY = "" #private.pem.key file path
PATH_TO_AMAZON_ROOT_CA_1 = "" #root ca file path
...
class MQTTConnectionManager:
    ...
    def _create_connection(self):
        try:
            ...
            mqtt_connection = mqtt_connection_builder.mtls_from_path(
                ...
                clean_session=False,
                keep_alive_secs=45,  # Increased keep-alive interval
    ...
    def connect(self):
        ...
        while not self.is_connected.is_set():
            try:
                ...
                retry_time = min(retry_time * 2, self.max_retry_time)  # Exponential backoff
    ...
    def on_message_received(self, topic, payload, **kwargs):
        try:
            ...
            # Ensure we have valid data before insertion
